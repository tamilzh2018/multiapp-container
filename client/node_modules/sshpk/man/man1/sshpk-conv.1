...
OpenSSL. The classic \fB\fC*REDACTED*\fR file is usually in this format. It is an ASN.1
encoded structure, base64\-encoded and placed between PEM headers.
.TP
\fB\fCssh\fR
The SSH public key text format (the format of an \fB\fC*REDACTED*.pub\fR file). A single
